...
import static com.markswell.payment.application.core.domain.enums.SaleEvent.FAILED_PAYMENT;
import static com.markswell.payment.application.core.domain.enums.SaleEvent.VALIDATED_PAYMENT;
...
public class SalePaymentUseCase implements SalePaymentInputPort {
    ...
    public void payment(Sale sale) {
        try {
            ...
            sendToKafkaPaymentOutputPort.send(sale, VALIDATED_PAYMENT);
        } catch (InsufficientFunds e) {
            sendToKafkaPaymentOutputPort.send(sale, FAILED_PAYMENT);
